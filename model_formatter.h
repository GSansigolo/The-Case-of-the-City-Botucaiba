...
void draw_dialogs(void) {
    ...
    if (d_pointer == 0){
        ...
        if(selected_language == 1){
          d_n("Voc~ & Renne Bras, uma detetive comum.",1);
            d("Voc~ entrou no neg$cio h* sete anos,",2);
            d("logo ap$s o fim de seu relacionamento",3);
        }
    }
    ...
    if (d_pointer == 1){
        ...
        if(selected_language == 1){
          d_n("mais longo. Voc~ se tornou famosa por",1);
    ...
    if (d_pointer == 2){
        if(selected_language == 0){
          d_n("Months have passed since the case of",1);
            d("the Lighthouse of SXo Bento do Oeste.",2);
            d("",3);
        }
        if(selected_language == 1){
          d_n("Meses se passaram desde o caso do",1);
            d("Farol de SXo Bento do Oeste.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3){
        ...
        if(selected_language == 1){
          d_n("Desde entXo voc~ se tornou uma",1);
            d("detetive atuante na regiXo do Sul de",2);
            d("Minas.",3);
        }
    }
    ...
    if (d_pointer == 4){
        ...
        if(selected_language == 1){
          d_n("Tudo mudou quando h* dias voc~ recebeu",1);
    ...
    if (d_pointer == 6){
        ...
        if(selected_language == 1){
          d_n("para convid*-la para uma viagem.",1);
            d("Faz meses que nXo nos vemos e por",2);
            d("isso queria convid*-la para passar",3);
        }
    }
    ...
    if (d_pointer == 7){
        ...
        if(selected_language == 1){
          d_n("as f&rias juntas. Caso voc~ nXo saiba,",1);
    ...
    if (d_pointer == 8){
        ...
        if(selected_language == 1){
          d_n("pol|tica do pa|s. E durante as f&rias",1);
    ...
    if (d_pointer == 9){
        if(selected_language == 0){
          d_n("to travel to the city of Botuca|ba,",1);
            d("in the interior of SXo Paulo. You may",2);
            d("be wondering why a teacher from SXo",3);
        }
        if(selected_language == 1){
          d_n("Botuca|ba, interior de SXo Paulo.Voc~",1);
            d("deve estar se perguntando por que uma",2);
            d("professora de SXo Bento do Oeste iria ",3);
        }
    }
    ...
    if (d_pointer == 10){
        if(selected_language == 0){
          d_n("Bento do Oeste would want to spend",1);
            ...
            d("interior of SXo Paulo want to spend",3);
        }
        if(selected_language == 1){
          d_n("querer ir passar as f&rias em uma",1);
            d("cidade no interior de SXo Paulo. Para",2);
    ...
    if (d_pointer == 11){
        if(selected_language == 0){
          d_n("her vacation in a town in the",1);
            d("countryside of SXo Paulo. To know",2);
    ...
    if (d_pointer == 14){
        if(selected_language == 0){
            h("[ Renne ]",1);
                        d("Interior of SXo Paulo...",1);
            d("Why do you want to drag me to these",2);
            d("places.",3);
        }
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Interior de SXo Paulo...",1);
            d("Porque voc~ quer me arrastar para",2);
            d("esses lugares.",3);
        }
    }
    ...
    if (d_pointer == 15){
        ...
        if(selected_language == 1){
          d_n("Voc~ reclamou por minutos.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 19){
        if(selected_language == 0){
            ...
            d("city to another in SXo Paulo.",2);
            d("",3);
        }
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Como as pessoas vXo de",1);
            d("uma cidade para outra em SXo Paulo.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 21){
        ...
        if(selected_language == 1){
          d_n("Voc~ ficou minutos esperando na",1);
    ...
    if (d_pointer == 24){
        ...
        if(selected_language == 1){
          d_n("Algumas pessoas olharam para voc~.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 27){
        ...
        if(selected_language == 1){
          d_n("Voc~ se lembrou que no e-mail ela nXo",1);
            d("disse que esperaria voc~ na entrada",2);
            d("da cidade.",3);
        }
    }
    ...
    if (d_pointer == 30){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Essa nXo & uma cidade",1);
            d("grande, vou procurar ela a p&.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 2042){
        ...
        if(selected_language == 1){
          d_n("Voc~ continuou a procurar por pessoas.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 2055){
        ...
        if(selected_language == 1){
            h("[ Flavio ]",1);
                        d(" As pessoas nXo veem a",1);
            d("cidade. Existem outras cidade, ningu&m",2);
    ...
    if (d_pointer == 3035){
        ...
        if(selected_language == 1){
          d_n("Enquanto voc~ andava pela avenida",1);
            d("voc~ notou uma coisa.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3036){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Haviam pouqu|ssimos carros",1);
    ...
    if (d_pointer == 3038){
        ...
        if(selected_language == 1){
            ...
            d("quil}metro voc~ avistou uma coisa que",2);
            d("chamou sua aten_Xo.",3);
        }
    }
    ...
    if (d_pointer == 3039){
        if(selected_language == 0){
          d_n("A sign with the words, 'Come and",1);
            d("live in Butuca|ba'.",2);
            d("",3);
        }
        if(selected_language == 1){
          d_n("Uma placa com os dizerem, 'venham",1);
            d("morar em Butuca|ba.'.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3040){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Uma pol|tica para convidar",1);
    ...
    if (d_pointer == 3041){
        ...
        if(selected_language == 1){
          d_n("Eu notei que essa cidade & um pouco",1);
            d("vazia, por&m noticiar isso em uma",2);
            d("placa.",3);
        }
    }
    ...
    if (d_pointer == 3042){
        ...
        if(selected_language == 1){
          d_n("Depois de minutos voc~ decidiu parar",1);
    ...
    if (d_pointer == 3046){
        ...
        if(selected_language == 1){
          d_n("Depois de fica minutos descansando",1);
            d("voc~ se levantou e continuou andando",2);
            d("na avenida.",3);
        }
    }
    ...
    if (d_pointer == 3047){
        ...
        if(selected_language == 1){
          d_n("Andar pela avenida fez voc~ pensar",1);
            d("na Julia.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3048){
        ...
        if(selected_language == 1){
            ...
            d("viria passar as f&rias aqui.",3);
        }
    }
    ...
    if (d_pointer == 3049){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Tem alguma motiva_Xo da",1);
            d("Julia que ainda nXo estou vendo.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3053){
        ...
        if(selected_language == 1){
          d_n("Voc~ come_ou a observar com detalhes",1);
            d("a cidade, procurando por algo que",2);
            d("chamasse aten_Xo.",3);
        }
    }
    ...
    if (d_pointer == 3059){
        ...
        if(selected_language == 1){
          d_n("Voc~ nXo conseguiu pensar em nada.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 63){
        ...
        if(selected_language == 1){
          d_n("Voc~ observou que ao final da avenida,",1);
    ...
    if (d_pointer == 69){
        ...
        if(selected_language == 1){
          d_n("Depois de minutos voc~ encontrou ",1);
            d("algu&m.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 78){
        ...
        if(selected_language == 1){
          d_n("Voc~ apontou para a avenida que voc~ ",1);
            d("percorreu.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 86){
        ...
        if(selected_language == 1){
            h("[ Carol ]",1);
                        d("Essa & um pergunta",1);
            d("complicada, eu vim para a cidade faz",2);
            d("um m~s. NXo conhe_o muito sobre ela.",3);
        }
    }
    ...
    if (d_pointer == 89){
        ...
        if(selected_language == 1){
          d_n("Voc~ ficou minutos sentada olhando",1);
            d(" para a cidade.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 90){
        ...
        if(selected_language == 1){
            ...
            d("vale criou mil d#vidas na minha",2);
            d("cabe_a.",3);
        }
    }
    ...
    if (d_pointer == 92){
        ...
        if(selected_language == 1){
          d_n("Exclamou uma voz fam|lias.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 99){
        ...
        if(selected_language == 1){
          d_n("Julia se virou em dire_Xo da cidade.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 107){
        ...
        if(selected_language == 1){
            ...
            d("escala de cidade habit*vel do Brasil.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 109){
        ...
        if(selected_language == 1){
            ...
            d("exclusivamente para esse prop$sito.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 110){
        if(selected_language == 0){
            h("[ Julia ]",1);
                        d("In the case of Botuca|ba,",1);
            d("By default every residential building",2);
            d("have municipal schools, kindergartners,",3);
        }
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("No caso de Botuca|ba, por",1);
            d("padrXo todos edif|cios residenciais",2);
            d("t~m escolas municipais, creches,",3);
        }
    }
    ...
    if (d_pointer == 116){
        ...
        if(selected_language == 1){
            ...
            d("saber por que nXo & tXo conhecida.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 117){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Porque nXo tem um",1);
            d("document*rio na TV domingo falando",2);
    ...
    if (d_pointer == 120){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Esse & um caso especial,",1);
            d("vamos precisar resolv~-lo sem",2);
    ...
    if (d_pointer == 122){
        ...
        if(selected_language == 1){
            ...
            d("situa_Xo dif|cil, & como se n$s",2);
            d("f}ssemos as #nicas testemunhas.",3);
        }
    }
    ...
    if (d_pointer == 125){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("As pessoas de fora nXo",1);
            d("sabem dessa cidade por alguma razXo.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 126){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Os moradores desta cidade nXo",1);
            d("vXo nos ajudar a resolver este caso,",2);
            d("pois eles vivem aqui e por isso nXo",3);
        }
    }
    ...
    if (d_pointer == 129){
        ...
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Entendi. NXo tem ningu&m",1);
            d("aqui que nXo conhece a cidade.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 131){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Vamos juntar as pe_as, o",1);
            d("que n$s sabemos at& agora?",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 133){
        ...
        if(selected_language == 1){
            ...
            d("habit*vel. Eu encontrei uma mat&ria",2);
            d("da &poca que noticiava o projeto.",3);
        }
    }
    ...
    if (d_pointer == 134){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("O projeto? NXo tinha",1);
            d("mat&ria sobre o t&rmino?",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 2138){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("O que voc~ sabe sobre a",1);
            d("ind#stria na regiXo?",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 2139){
        ...
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Ela & bem normal, algumas",1);
            d("f*bricas grandes aqui e ali, mas s$",2);
            d("isso.",3);
        }
    }
    ...
    if (d_pointer == 2142){
        ...
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Ao norte tem uma f*brica",1);
            d("de autom$veis Wolff, e a sul tem um",2);
            d("parque tecnol$gico.",3);
        }
    }
    ...
    if (d_pointer == 2143){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Duas dessas quatro nXo",1);
            d("parecem ter nenhuma interfer~ncia a",2);
            d("princ|pio.",3);
        }
    }
    ...
    if (d_pointer == 2148){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Entendi. EntXo o bairro",1);
            d("novo est* aqui a vinte anos. ",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 2149){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Eu aposto com voc~ que",1);
            d("tr~s dessas quatro f*bricas que voc~",2);
            d("citou sXo de antes de 2000.",3);
        }
    }
    ...
    if (d_pointer == 2150){
        ...
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Todas sXo. Quando fiz o",1);
            d("levantamento de dados do artigo,",2);
            d("procurei por ind#strias da regiXo.",3);
        }
    }
    ...
    if (d_pointer == 3140){
        ...
        if(selected_language == 1){
            ...
            d("de pol|tico tem muito na regiXo?",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3141){
        if(selected_language == 0){
            h("[ Julia ]",1);
                        d("No, the interior of SXo",1);
            d("Paulo doesn't usually have politicians",2);
            d("like this.",3);
        }
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("NXo, o interior de SXo",1);
            d("Paulo nXo costumo ter pol|ticos assim.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 3142){
        ...
        if(selected_language == 1){
            ...
            d("cidades vizinhas t~m prefeitos vindos",2);
            d("da ind#stria.",3);
        }
    }
    ...
    if (d_pointer == 3143){
        ...
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Desde automobil|stica com",1);
            d("a Wolff, h* empresas de papel e",2);
    ...
    if (d_pointer == 3144){
        ...
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Tamb&m tem um polo",1);
            d("cient|fico ao sul, com um parque",2);
            d("tecnol$gico.",3);
        }
    }
    ...
    if (d_pointer == 3145){
        ...
        if(selected_language == 1){
            ...
            d("coisa que conecta todas as lideran_as",2);
            d("da regiXo.",3);
        }
    }
    ...
    if (d_pointer == 3149){
        ...
        if(selected_language == 1){
            ...
            d("vinte anos que essa cidade est* sendo",2);
    ...
    if (d_pointer == 3151){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Estou come_ando a conectar",1);
            d("os pontos.",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 152){
        ...
        if(selected_language == 1){
          d_n("Voc~ se virou para a cidade.",1);
            d("",2);
            d("",3);
        }
    }
    ...
    if (d_pointer == 156){
        ...
        if(selected_language == 1){
          d_n("Voc~ e Julia ficaram observando o",1);
    ...
    if (d_pointer == 157){
        if(selected_language == 0){
            h("[ Julia ]",1);
                        d("If it weren't for SXo",1);
            d("Bento do Oeste and everything I've",2);
            d("built there.",3);
        }
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Se nXo fosse por SXo",1);
            d("Bento do Oeste e tudo que constru|",2);
            d("l*.",3);
        }
    }
    ...
    if (d_pointer == 159){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("Eu tamb&m. É uma cidade",1);
            d("muito #nica. E eu ainda poderia morar",2);
            d("perto de voc~ de novo.",3);
        }
    }
    ...
    if (d_pointer == 162){
        ...
        if(selected_language == 1){
          d_n("Voc~ e Julia ficaram minutos",1);
    ...
    if (d_pointer == 165){
        ...
        if(selected_language == 1){
          d_n("Voc~ apontou para um pr&dio da cidade.",1);
            d("",2);
            d("",3);
        }
    }
  ...
  if (d_pointer == 166){
    ...
    if (d_pointer == 167){
        ...
        if(selected_language == 1){
            h("[ Renne ]",1);
                        d("EntXo al&m de tudo que",1);
            d("voc~ falou pr$ximo das moradias tem",2);
            d("trabalho pr$ximo?",3);
        }
    }
    ...
    if (d_pointer == 168){
        if(selected_language == 0){
            ...
            d("main points of this city model. Having",2);
            d("work within a 15-minute walk.",3);
        }
        if(selected_language == 1){
            h("[ Julia ]",1);
                        d("Sim, essa & um dos",1);
            d("principais pontos desse modelo de",2);
            d("cidade. O trabalho ficar 15 min a p*.",3);
        }
    }
